...
На картинке: фон — спортивная карта, синяя линия — путь спортсменки по GPS, красная линия со стрелкой и чёрной обводкой — направление сплита, круги — контрольные точки.
"""
        if image_path
